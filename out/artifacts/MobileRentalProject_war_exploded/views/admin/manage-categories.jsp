...
<head>
    ...
    <title>Manage Categories - Admin - MotoRent</title>
        ...
        <div class="row">
            <div class="col-md-3 col-lg-2 d-md-block sidebar collapse bg-white p-3">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column gap-2">
                        ...
                        <li class="nav-item"><a class="nav-link active d-flex align-items-center gap-3" href="${pageContext.request.contextPath}/admin?action=manageCategories"><i class="fa-solid fa-tags"></i> Categories</a></li>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                <div class="d-flex justify-content-between align-items-center pt-3 pb-2 mb-4 border-bottom">
                    <h1 class="h2 fw-bold">Manage Categories</h1>
                        ...
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                <c:forEach var="cat" items="${categories}">
                                    <tr>
                                        <td class="fw-semibold">${cat.categoryId}</td>
                                        <td class="fw-bold">${cat.categoryName}</td>
                                        <td class="text-muted">${cat.description}</td>
                                        <td><fmt:formatDate value="${cat.createdAt}" pattern="MMM dd, yyyy"/></td>
                                        <td>
                                            <button class="btn btn-sm btn-outline-primary rounded-pill px-3 me-1"
                                                    data-bs-toggle="modal" data-bs-target="#editCategoryModal${cat.categoryId}">
